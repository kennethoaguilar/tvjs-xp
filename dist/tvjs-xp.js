/*!
 * TVJS Std Extension Pack - v0.6.0 - Wed Jan 15 2025
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.id, "\n.tvjs-x-window.sett-win[data-v-6c3a2218] {\n    padding-bottom: 30px;\n    border: 1px solid #80808011;\n}\n.sett-win-item[data-v-6c3a2218] {\n    display: flex;\n    flex-direction: row;\n    flex-wrap: nowrap;\n    justify-content: flex-start;\n    align-content: center;\n    align-items: center;\n}\n.sett-win-item label[data-v-6c3a2218] {\n    min-width: 80px;\n    color: #35a776;\n}\n.sett-win-empty[data-v-6c3a2218] {\n    opacity: 0.5;\n}\n", ""]);
// Exports
module.exports = exports;
...
// add the styles to the DOM
var add = (__webpack_require__(534)/* ["default"] */ .A)
var update = add("400cc744", content, false, {});
// Hot Module Replacement
if(false) {}
...
/* harmony default export */ const indicators = (indicators_Pack);
...
;// ./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/extensions/settings-win-2/SettingsWin.vue?vue&type=template&id=6c3a2218&scoped=true
var SettingsWinvue_type_template_id_6c3a2218_scoped_true_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c("window", {
    staticClass: "sett-win",
...
var SettingsWinvue_type_template_id_6c3a2218_scoped_true_staticRenderFns = [];
SettingsWinvue_type_template_id_6c3a2218_scoped_true_render._withStripped = true;

;// ./src/extensions/settings-win-2/SettingsWin.vue?vue&type=template&id=6c3a2218&scoped=true

;// ./src/extensions/settings-win-2/utils.js
/* harmony default export */ const settings_win_2_utils = ({
  sett2desc: function sett2desc(sett) {
    function setCharAt(str, index, chr) {
      if (index > str.length - 1) return str;
      return str.substring(0, index) + chr + str.substring(index + 1);
...
;// ./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/extensions/settings-win-2/SettingsWin.vue?vue&type=script&lang=js




/* harmony default export */ const settings_win_2_SettingsWinvue_type_script_lang_js = ({
  name: 'SettingsWin',
  props: ['id', 'main', 'dc', 'tv', 'data'],
  components: {
    Window: Window,
  ...
  methods: {
    s2d: function s2d(str) {
      return settings_win_2_utils.sett2desc(str);
    },
    on_close: function on_close() {
      this.$props.main.remove_widget(this.$props.id);
    },
...
;// ./src/extensions/settings-win-2/SettingsWin.vue?vue&type=script&lang=js
 /* harmony default export */ const extensions_settings_win_2_SettingsWinvue_type_script_lang_js = (settings_win_2_SettingsWinvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-style-loader/index.js!./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/extensions/settings-win-2/SettingsWin.vue?vue&type=style&index=0&id=6c3a2218&prod&scoped=true&lang=css
var SettingsWinvue_type_style_index_0_id_6c3a2218_prod_scoped_true_lang_css = __webpack_require__(613);
;// ./src/extensions/settings-win-2/SettingsWin.vue?vue&type=style&index=0&id=6c3a2218&prod&scoped=true&lang=css

;// ./src/extensions/settings-win-2/SettingsWin.vue
...
var settings_win_2_SettingsWin_component = normalizeComponent(
  extensions_settings_win_2_SettingsWinvue_type_script_lang_js,
  SettingsWinvue_type_template_id_6c3a2218_scoped_true_render,
  SettingsWinvue_type_template_id_6c3a2218_scoped_true_staticRenderFns,
  false,
  null,
  "6c3a2218",
  null
...
/* harmony default export */ const settings_win_2_SettingsWin = (settings_win_2_SettingsWin_component.exports);
;// ./src/extensions/settings-win-2/main.js
...
var settings_win_2_main_Main = /*#__PURE__*/function () {
  function Main(tv, dc) {
    _classCallCheck(this, Main);
    this.widgets = {};
    this.tv = tv;
      ...
      switch (e.event) {
        case 'legend-button-click':
          ...
          try {
            ...
            this.tv.$set(this.widgets, id, {
              id: id,
              cls: settings_win_2_SettingsWin,
              data: {
                ov: ov
              }
            });
...
;// ./build/settings-win-2/settings-win-2.js
// -------- Production extension index ---------
//      ! THIS FILE WAS AUTO-GENERATED !
//
// Do not commit this file, the final index is
...
settings_win_2_main_Main.__name__ = 'settings-win-2';
var settings_win_2_widgets = {
  SettingsWin: settings_win_2_SettingsWin
};
var settings_win_2_components = {};
var settings_win_2_overlays = {};
var settings_win_2_colorpacks = {};
var settings_win_2_skins = {};
var settings_win_2_Pack = {
  widgets: settings_win_2_widgets,
  SettingsWin: settings_win_2_SettingsWin,
  components: settings_win_2_components,
  overlays: settings_win_2_overlays,
  colorpacks: settings_win_2_colorpacks,
  skins: settings_win_2_skins,
  Main: settings_win_2_main_Main
};
/* harmony default export */ const settings_win_2 = (settings_win_2_Pack);
